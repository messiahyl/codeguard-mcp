...
server.tool(
  "scan_code",
  "Scan source code for security vulnerabilities, code smells, and performance issues. Returns a detailed report with severity levels and fix suggestions.",
  {
...
server.tool(
  "list_rules",
  "List all available security scanning rules organized by category.",
  {
    category: z
...
server.tool(
  "quick_check",
  "Quickly check if a code snippet contains a specific vulnerability pattern.",
  {
